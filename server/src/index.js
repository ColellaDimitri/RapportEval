...
const renderReportHeader = (doc, reportTitle, reportDate) => {
  const headerX = 40;
  const headerY = 40;
  ...
  doc
    .font("Helvetica")
    .fontSize(10)
    .text(formatDate(reportDate || new Date()), headerX + logoWidth + titleWidth, headerY + 12, {
      width: dateWidth,
      align: "center"
    });
...
const renderCoachingReport = (doc, student) => {
  ...
  const availableHeight = footerY - footerGap - sectionStartY;
